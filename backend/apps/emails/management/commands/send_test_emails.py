...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        templates_to_test = [
            ...
            ("It's not too late to turn this around.", "retention/missed_21_days"),
            ("Come back. Start again.", "retention/missed_30_days"),
            ("Do you remember why you started?", "retention/missed_60_days"),
            ("The arena is still waiting for you.", "retention/missed_90_days"),
