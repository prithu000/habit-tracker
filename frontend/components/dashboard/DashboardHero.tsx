...
export function DashboardHero() {
  ...
  return (
    <div>
      {/* ── Mobile View (< md): Clean, simple, non-complex header ── */}
      <div className="block md:hidden pb-3">
        ...
        >
          ...
          <p className="text-xs leading-relaxed" style={{ color: "var(--fg-muted)" }}>
            <strong className="font-semibold" style={{ color: "var(--fg)" }}>YOU VS YOU</strong> helps you track daily habits, master consistency, and outwork your past self.
          </p>
        </div>
      </div>

      {/* ── Desktop View (md+): Balanced, elegant hero layout ── */}
      <div className="hidden md:grid md:grid-cols-[1fr_280px] gap-5 pb-6">
        {/* Left: Hero copy */}
        <div className="space-y-4">
          ...
          >
            YOU VS YOU is your personal operating system to build atomic habits,
            execute daily routines, and measure consistency to become a better
