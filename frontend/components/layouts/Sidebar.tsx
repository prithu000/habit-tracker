          ...
          {navItems.map((item) => {
            ...
            return (
              <Link 
                ...
                title={isSidebarCollapsed ? `${item.label}${isLocked ? " (Pro)" : ""}` : undefined}
              >
                <div
                  className={cn(
                ...
                >
                  ...
                  />
                  {!isSidebarCollapsed && (
                    <span className="whitespace-nowrap tracking-wide flex-1">{item.label}</span>
                  )}
                  ...
                  {isSidebarCollapsed && isLocked && (
                    <div className="absolute right-1 top-1 w-1.5 h-1.5 bg-amber-400 rounded-full" />
                  )}
                </div>
              </Link>
            );
